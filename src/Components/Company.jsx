        ...
        <Container className="my-4">
            <Row>
                ...
                <Col md={9} sm={6}>
                    ...
                    <p className="text-parrafo">Alguna de las cualidades más valoradas en el mundo empresarial son la fidelidad y el compromiso que tiene un empleado con los objetivos, metas y desarrollo de la empresa, donde labore, por esa razon es necesario que realices una investigación sobre la empresa en que vas  postularte, los aspectos mas releantes de la empresa como misión, visión, valores, directivos actuales entre otros, los aspectos externos de la empresa coo su posicionamiento comercial, competencias, ventas realizadas o fluctuación de su economia, obeten est información por medio de herramientas como los motores de busquedas de internet o una red de contactos confiable para asegurar la veracidad de la información, al mencionar estos datos en una entrevista lograras transmitir tu interes en ser parte de su equipo de trabajo mostrando el compromiso y fidelidad que podrias ofrecer a la empresa</p>
                </Col>
            </Row>
            <Row>
                <Col>
            ...
            <Row>
                ...
                <p className="text-parrafo">La investigación interna de la empresa esta constituida por la misión, visión, personas que la conforman y otros aspectos relevantes, para realizar una investigación de la empresa, informate sobre su giro, historia y actividades en su página web, esta información se encuentra regularmente en la sección acerca de nosotros, identifica el perfil de las vacantes publicadas para conocer las habilidades que requieren, puedes conseguir esta información en su bolsa de trabajo aunque no todas las empresas ceuntan con una, investiga sobre el ambiente de trabajo, puedes consultar ranking en diversos sitios y publicaciones o en la redes sociales, busca noricas de la compañia asi podras infromarte sobre la rotación se los ejecutivos, lanzamientos de nueos prodductos, premios que se le hallan otrogado y reportes de ingresos.</p>
            </Row>
        </Container>
    )
}
