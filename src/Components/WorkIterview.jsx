        ...
        <Container className="my-2">
            <Row>
                ...
                <Col md={4} sm={12}>
                    ...
                    <hr />
                    <p className="text-parrafo">Indentifica las habilidades que te harán destacar sobre otros candidatos y prepara una respuesta para aquellos aspectos que consideres débiles sobre tu hoja de vida </p>
